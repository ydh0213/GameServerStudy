...
<p align="center">
  <img alt="클라 200개 연결" src="https://github.com/user-attachments/assets/94fd37ca-d070-446a-8c60-a1c3aad3b8b7" /><br>
  <i>200개 연결하고 백로그 큐가 꽉차서 10061 에러가 난 모습</i>
</p>
...
<p align="center">
  <img alt="클라 13000개 연결" src="https://github.com/user-attachments/assets/ba2b88f7-f5df-41dd-9300-d9f19e6679d4" /><br>
  <i>13,000개 연결하고 포트가 부족해서 10055 에러가 난 모습</i>
</p>
...
<p align="center">
  <img alt="" src="https://github.com/user-attachments/assets/0acca73f-733d-4682-ac2e-9af9d5909a56" /><br>
  <i>출처: sunyzero.tistory.com/198</i>
</p>
...
<p align="center">
  <img width="49%" alt="65535개 연결 클라 1" src="https://github.com/user-attachments/assets/277b0d07-7d64-4616-8aca-ee614c3fb347" />
  <img width="49%" alt="65535개 연결 클라 2" src="https://github.com/user-attachments/assets/d4993925-fea6-4e57-944c-3ecca29ae09a" /><br>
  <i>65535개 연결 클라이언트</i>
</p>

<p align="center">
  <img alt="65535개 연결 서버" src="https://github.com/user-attachments/assets/51af288f-bef7-4382-8f07-234e08ea10f9" /><br>
  <i>65535개 연결 서버</i>
</p>
...
<p align="center">
  <img alt="서버를 갓 실행했을 때 29K" src="https://github.com/user-attachments/assets/fed1714f-e5ca-491e-8af4-b33ae1b86ce9" /><br>
  <i>서버를 갓 실행했을 때 29K</i>
</p>

<p align="center">
  <img alt="백로그 큐에 적재만 하고 Accept하기 전 16,413K" src="https://github.com/user-attachments/assets/618d63bb-e6ea-40a2-a8c8-294bd925f4d8" /><br>
  <i>백로그 큐에 적재만 하고 Accept하기 전 16,413K</i>
</p>
...
## 클라이언트를 비동기로 바꾸기
### 동기
클라이언트 프로그램을 13200개씩 연결하고 바로 Close하는 걸 반복하게 구현했다. 순차적으로 연결하는 방식이다. 1번째 연결이 성공하고 나서 2번째 연결을 시도하고, 2번째 연결이 성공하고 나서 3번째 연결을 시도하고, ... 13200개가 진행되면 전부 Close를 하고, 다시 반복한다. 총 65535개 연결 후 그 다음 연결 실패가 되며 `isQueueFull = true`가 되어 while문이 종료된다.<br>
### 비동기
이제 비동기 클라 폭격기를 만들어보고자 `Connect()` 대신 `ConnectAsync()`를 썼다. 13200개 연결 작업을 한꺼번에 시도한다. 전부 완료되면 Close를 하고, 다시 반복한다.<br>
하나의 PC에서 서버와 클라를 돌려서 그런지, 단순접속만 했다가 끊는 간단한 작업이라 그런지, 동기/비동기 차이는 그리 체감은 되지 않았다. 하지만 실제 현실에서도 접속이 순차적으로 들어오는 이상적인 상황보다는 동시에 막 들어오는 경우들이 대부분일 거라서 비동기 쪽이 더 현실성있는 테스트일 것이다.
